        ...
        if (selectedIds.length >= 1) {
            for (let itemId of selectedIds) {
                ...
                if (suDungDichVu != null) {
                    ...
                    let tieuDe = "Thông báo " + hocSinh.tenHocSinh + " cần thanh toán dịch vụ " + dichVu.tenDichVu;
                    var emailContent = `
                        <div class="content">
                            <p>Xin chào Phụ huynh <strong>`+ hocSinh.tenHocSinh + ` </strong>,</p>
                            <p> Chúng tôi xin nhắc nhở bạn về việc thanh toán cho dịch vụ <strong>`+ dichVu.tenDichVu + `</strong> mà bạn đã đăng ký vào ngày ` + suDungDichVu.ngayBatDau +`</p>
                            <table>
                                <tr>
